...
from sqlalchemy import Column, Integer, BigInteger, String, DateTime, ForeignKey, Numeric, Boolean, Enum
...
class User(Base):
    ...
    reg_date = Column(DateTime(timezone=True), nullable=False, default=lambda: datetime.now(timezone.utc))
